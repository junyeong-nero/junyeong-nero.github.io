...
(function () {
    var translations = {
        ko: {
            ...
            'card.cj': '드라마 분석용 멀티에이전트 파이프라인',
            'card.troja': '딥페이크 방어 스타트업',
            'card.embedded': 'UNIST',
            'card.rubisco': 'Flutter 제품 개발 및 하드웨어 프로토타이핑',
    ...
    var defaults = {
        ...
        'card.cj': 'Multi-Agent Pipeline for Drama Analysis',
        'card.troja': 'Deepfake Prevention Startup',
        'card.embedded': 'UNIST',
        'card.rubisco': 'Flutter Products and Hardware Prototypes',
        'award.awards': 'Awards',
