---
layout: single
title: "Medical Vision & NLP 프로젝트 경험: MAIC 대회 참가 역량 소개"
date: 2025-12-24 10:00:00 +0900
categories: Projects
tags: [Medical Vision, NLP, MedSAM, LLM]
---
...
- Code: [https://github.com/junyeong-nero/MedSAM2](https://github.com/junyeong-nero/MedSAM2)
- Dataset: [https://huggingface.co/datasets/junyeong-nero/mri-brain-tumor-segmentation-medsam2](https://huggingface.co/datasets/junyeong-nero/mri-brain-tumor-segmentation-medsam2)

**Project: Korean Medical LLM**

- Model: [https://huggingface.co/ChuGyouk/ko-med-gemma-2-9b-it-merge2](https://huggingface.co/ChuGyouk/ko-med-gemma-2-9b-it-merge2)
